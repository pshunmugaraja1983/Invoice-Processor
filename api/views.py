...
def print_request(request):
    ...
    print("Print values for REQUEST METHOD --> GET");
...
def create_table():
    ...
    try:
        ...
        print("Exception Raised - Database Connection");
        print(e)
...
def insert_data(cust_id, inv_id):
    ...
    print ("Insert data with values ", cust_id, inv_id)
    conn = mysql.connector.connect(host=hostname, user=username, passwd=password, db=database)
    cur = conn.cursor()

    temp_query = "INSERT INTO invoice (cust_id, inv_id) VALUES ('" + cust_id +   "', '" +  inv_id + "')"
